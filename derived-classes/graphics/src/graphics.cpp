...
, line_vert { device, "derived-classes/graphics/test/shader/line.vert.spv" }
, line_frag { device, "derived-classes/graphics/test/shader/line.frag.spv" }
, line_layout { device, get_line_bindings() }
, mesh_vert { device, "derived-classes/graphics/test/shader/mesh.vert.spv" }
, mesh_frag { device, "derived-classes/graphics/test/shader/mesh.frag.spv" }
