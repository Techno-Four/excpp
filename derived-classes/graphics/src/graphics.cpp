...
, vert { device, "derived-classes/graphics/test/shader/vert.spv" }
, frag { device, "derived-classes/graphics/test/shader/frag.spv" }
//, point_vert { device, "derived-classes/graphics/test/shader/point.vert.spv" }
//, point_frag { device, "derived-classes/graphics/test/shader/point.frag.spv" }
, layout { device }
